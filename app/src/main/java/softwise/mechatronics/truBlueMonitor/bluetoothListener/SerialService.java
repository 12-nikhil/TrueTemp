...
public class SerialService extends Service implements SerialListener {
    ...
    public void write(byte[] data) throws IOException {
        if(!connected)
            throw new IOException(this.getApplication().getString(R.string.msg_not_connected));
        socket.write(data);
    }
    ...
    private void createNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, BluetoothConstants.NOTIFICATION_CHANNEL)
                ...
                .setOngoing(true);
                /*.addAction(new NotificationCompat.Action(R.drawable.ic_baseline_clear_24, "Disconnect", disconnectPendingIntent));*/
                ...
                if (listener != null) {
                    mainLooper.post(() -> {
                        if (listener != null) {
                            ...
                            //Log.d("Read data", String.valueOf(data));
                        } else {
